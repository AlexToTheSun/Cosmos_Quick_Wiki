...
# Set the variables
read -p "Type bech_prefix of your project (haqq): " bech_prefix
mintscan_prefix=haqq
read -p "Type mintscan_prefix of your project (most often this is the same as bech_prefix): " mintscan_prefix
read -p "Type bech_validator_prefix of your project (haqqvaloper): " bech_validator_prefix
...
read -p "Type validator_page_pattern of your project (https://haqq.explorers.guru/validator/): " validator_page_pattern
